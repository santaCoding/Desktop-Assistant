...
class MainWindow:
    ...
    def initUI(self):
        ...
        self.ENTER.bind('<Button-1>', self.bot.CF.enter)
        ...
        self.LABEL = Label(self.frame_bot, width = 35, height = 23, text = random.choice(self.bot.cong),
        ...
        self.INPUT.bind('<Return>', self.bot.getResponse)
        self.BUTTON.bind('<Button-1>', self.bot.getResponse)
